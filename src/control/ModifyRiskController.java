...
public class ModifyRiskController {
    ...
    @FXML
    private Button riskModiftButton;

    @FXML
    private Button newRiskCanselButton;

    @FXML
    private TextField newRiskName;

    @FXML
    private TextField newRiskDes;

    @FXML
    private TextField newRiskcon;
